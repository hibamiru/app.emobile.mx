...
function allow_form_validation() {
	...
	if ($user_data['p_nivel_se'] == 'Preescolar' OR $user_data['p_nivel_se'] == 'Primaria')
	{
		$user_data['p_modalidad']		= $user_data['p_modalidad_pre_pri']?($user_meta['p_modalidad_pre_pri'][0]!='null'?'True':'False'):('False');
	}
	else if ($user_data['p_nivel_se'] == 'Secundaria')
	{
		$user_data['p_modalidad']		= $user_data['p_modalidad_sec']?($user_meta['p_modalidad_sec'][0]!='null'?'True':'False'):('False');
	}
	else if ($user_data['p_nivel_se'] == 'Educación especial')
	{
		$user_data['p_modalidad']		= $user_data['p_modalidad_eesp']?($user_meta['p_modalidad_eesp'][0]!='null'?'True':'False'):('False');
	}
